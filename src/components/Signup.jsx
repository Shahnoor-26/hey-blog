...
import { Spin, Button, Input, Logo } from "../components/index.js";
        ...
        <div className="w-fit sm:w-1/2 md:w-3/5 xl:w-2/5 mt-5 mb-5 p-2.5 md:p-5 bg-primary-color border-secondary-accent border md:border-2 rounded text-base md:text-lg xl:text-xl">
          <div className="m-2 p-2 space-y-2 text-center">
            ...
            <p className="text-sm md:text-base xl:text-lg">
              ...
              <Link
                to={"/login"}
                className="transition-all duration-200 ease-in-out outline-none focus:text-primary-accent focus:underline hover:text-primary-accent hover:underline"
              >
                Login
              </Link>
            </p>
